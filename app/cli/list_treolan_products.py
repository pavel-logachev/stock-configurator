...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="List saved Treolan products.")
...
def _available_summary(rows: list[DistributorStockPrice]) -> str:
    ...
    return f"{total} units, {locations} locations, {reservable} reservable"
