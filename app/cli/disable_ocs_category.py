...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Disable an OCS category for product sync.")
    parser.add_argument("--category-id", required=True, help="OCS category id to disable.")
