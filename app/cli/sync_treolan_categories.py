...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sync Treolan categories into the database.")
...
async def run() -> int:
    ...
    async with session_factory() as session:
        result = await sync_treolan_categories(session)

    print("Treolan categories sync summary")
